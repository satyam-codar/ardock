...
function Homeseccomp() {
    return (
        <div className='homeseccomp'>
                ...
                <div className="row">
                    <div className="col-md-6 col-lg-6 col-sm-12">
                        <div className="homeseccomptext">
                            ...
                            <p>
                                Inquietude attachment if ye an solicitude to. Remaining so continued
                                concealed as knowledge happiness. Preference did how expression may
                                favourable devonshire insipidity considered. An length design regret an
                                hardly barton mr figure. He went such dare good mr fact. The small own
                                seven saved man age no offer. Suspicion did mrs nor furniture smallness.
